                ...
                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                    <div class="about_text_wrapper">
                        ...
                        <p>Proin gravida nibh vel velit auctor aliquet. aks Aenean sollicitudin, lorem quis bibendum
                            auctor, nisi elit consequat ipsum, nec sagittis sem.consequat ipsum, nec sagittis sem nibh
                            id elit.Donec vestibulum justo a diam ultricies. pel lentesque. Quisque mattis diam vel.</p>
                        <p>Lorem Ipsum has been the industry's standard dummy text ever sincer they 1500s, when an
                            unknown printer took and galley of type and scrambled. nisi elit consequat ipsum, nec
                            sagittis sem nibh id elit.</p>
                        <ul>
                            <li><i class="fa fa-check-square" aria-hidden="true"></i><a href="/">We sell all over the
                                    world.</a>
                            </li>
                            <li><i class="fa fa-check-square" aria-hidden="true"></i><a href="/">Satisfaction or money
                                    refund guaranteed.</a>
                            </li>
                            <li><i class="fa fa-check-square" aria-hidden="true"></i><a href="/">Lifetime updates &
                                    support.</a>
                            </li>
                        </ul>
                    </div>
