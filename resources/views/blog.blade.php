                                ...
                                <div class="jp_first_blog_post_main_wrapper">
                                    <div class="jp_first_blog_post_slider">
                                        <div class="owl-carousel owl-theme">
                                            ...
                                            <div class="item">
                                                <img src='{{ asset("images/content/blog_img2.jpg") }}'class="img-responsive" alt="blog_img" />
                                            </div>
                                            <div class="item">
                                                <img src='{{ asset("images/content/blog_img3.jpg") }}'class="img-responsive" alt="blog_img" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="jp_first_blog_post_cont_wrapper">
                                ...
                                <div class="jp_first_blog_post_main_wrapper">
                                    <div class="et_progress_video_wrapper">
                                        <div class="et_progress_video">
                                            <img src='{{ asset("images/content/blog_img4.jpg") }}'class="img-responsive" alt="service_img" />
                                            <div class="et_progress_video_cont_overlay">
                                                <div class="et_progress_video_text"><a class="popup-youtube" href="https://www.youtube.com/embed/xImpyYRVGOc"><img src='{{ asset("images/content/play.png") }}'alt="video"></a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="jp_first_blog_post_cont_wrapper">
